...
public class NewLevel3 extends Level implements Screen , InputProcessor {

    private final transient Texture slingshot2 = new Texture("slingshot2.png");
    private final transient Texture backgroundTexture = new Texture("L3.png");
...
//    private transient ArrayList<Obstacle> activeObstacles;
    ...
    public NewLevel3(MainLauncher game, Player player, boolean load, GameState gameState) {
...
//        List<Obstacle> activeObstacles = new ArrayList<>(obstacles);
        ...
        if (!load) {
            ...
            cp3.position.set(690, 117);
            pigs.add(cp3);

            PrettyPig pp1 = new PrettyPig();
            pp1.position.set(560, 70);
            pigs.add(pp1);
            ...
            obstacles.add(new Stone(new Vector2(645, 110), Stone.Orientation.HORIZONTAL));
            obstacles.add(new Wood(new Vector2(555, 115), Wood.Orientation.HORIZONTAL));
            obstacles.add(new Wood(new Vector2(555, 70), Wood.Orientation.VERTICAL));
            obstacles.add(new Wood(new Vector2(505, 70), Wood.Orientation.BOX));
