...
public class NewLevel1 extends Level implements Screen , InputProcessor {
    ...
    public NewLevel1(MainLauncher game, Player player) {
        ...
        backgroundTexture = new Texture("L1.png");
        this.levelNumber = 1;
        ...
        if (player.getLoadedGame()==null||player.getLoadedGame().getLevel() instanceof Level1) {
            ...
            obstacles.add(new Wood(new Vector2(645, 120), Wood.Orientation.BOX));
        }
    }
