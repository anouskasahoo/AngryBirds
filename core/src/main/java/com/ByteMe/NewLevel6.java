...
public class NewLevel6 extends Level implements Screen , InputProcessor {

    private final transient Texture slingshot2 = new Texture("slingshot2.png");
    private final transient Texture backgroundTexture = new Texture("L6.png");
...
//    private transient ArrayList<Obstacle> activeObstacles;
    ...
    public NewLevel6(MainLauncher game, Player player, boolean load, GameState gameState) {
...
//Initialize pigs
            ...
            cp1.position.set(650, 70);
            pigs.add(cp1);

            ClassicPig cp2 = new ClassicPig();
            cp2.position.set(565, 70);
            pigs.add(cp2);

            ClassicPig cp3 = new ClassicPig();
            cp3.position.set(605, 205);
            pigs.add(cp3);

            ClassicPig cp4 = new ClassicPig();
            cp4.position.set(555, 165);
            pigs.add(cp4);

            ClassicPig cp5 = new ClassicPig();
            cp5.position.set(655, 165);
            pigs.add(cp5);

            ClassicPig cp6 = new ClassicPig();
            cp6.position.set(505, 120);
            pigs.add(cp6);

            ClassicPig cp7 = new ClassicPig();
            cp7.position.set(705, 120);
            pigs.add(cp7);

            PrettyPig pp1 = new PrettyPig();
            pp1.position.set(605, 112);
            pigs.add(pp1);

            KingPig kp1 = new KingPig();
            kp1.position.set(605, 245);
            pigs.add(kp1);

            obstacles.add(new Stone(new Vector2(470, 70), Stone.Orientation.H_BOX));
            obstacles.add(new Stone(new Vector2(690, 70), Stone.Orientation.H_BOX));
            obstacles.add(new TNT(new Vector2(605, 70)));
            obstacles.add(new TNT(new Vector2(605, 160)));
            obstacles.add(new Stone(new Vector2(605, 115), Stone.Orientation.VERTICAL));
            obstacles.add(new Stone(new Vector2(645, 115), Stone.Orientation.VERTICAL));
            obstacles.add(new Wood(new Vector2(605, 237), Wood.Orientation.HORIZONTAL));
            obstacles.add(new Wood(new Vector2(555, 115), Wood.Orientation.BOX));
            obstacles.add(new Wood(new Vector2(655, 115), Wood.Orientation.BOX));
...
//            game.setScreen(new Loss(game, 6, player));
//        }
    }
...
//        List<Obstacle> activeObstacles = new ArrayList<>(obstacles);
    ...
    private void checkGameConditions() {
        if (pigs.isEmpty()) {
            game.setScreen(new LoadedGame(game, player, false));
            return;
        }
